    ...
    >
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="relative" ref={notificationRef}>
          ...
          <div
            className={`absolute ${
              window.innerWidth < 768 ? "left-3/4 -translate-x-1/2" : "right-0"
            } mt-2 w-64 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 transition-all duration-300 ease-in transform ${
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          <div
            className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 transition-all duration-300 ease-in transform ${
