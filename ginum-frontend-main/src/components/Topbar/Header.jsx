...
const Header = ({ toggleSidebar, isSidebarVisible }) => {
  ...
  return (
    <div
      className={`bg-white/80 backdrop-blur-lg border-b border-slate-200/60 shadow-sm px-6 py-3.5 flex justify-between items-center fixed top-0 left-0 lg:left-[260px] right-0 transition-all duration-300 z-40 h-16`}
    >
