...
public class DesignationService {
    ...
    public Designation createDesignation(Integer companyId, DesignationDto designationDto) {
        ...
        Department department = departmentRepository.findByCompany_CompanyIdAndCode(companyId, designationDto.getDepartmentCode())
                .orElseThrow(() -> new RuntimeException("Department not found with code: " + designationDto.getDepartmentCode()));
