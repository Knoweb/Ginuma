        ...
        <div class="col col-xl-8">
            <div class="card shadow-lg" style="border-radius: 1rem;">
                <div class="card-body p-4 p-md-5">
                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add New Employee</h3>
                    <form class="row g-3" method="post" action="../../backend/data/add-employee-data.php"
                        enctype="multipart/form-data">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="epf_no" id="epf_no" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" name="date_joined" id="date_joined" required>
                        </div>
                        <div class="col-md-4">
...
<script>
    $(document).prop('title', 'Add Employee | Ginum');
    ...
    $(document).ready(function() {
        ...
        // Attach the change event directly to the select element
        $(".dpt").change(function() {
            let dpt_id = $(this).val();
            $.ajax({
        ...
        $("#addDesignationLink").click(function(e) {
            e.preventDefault();
