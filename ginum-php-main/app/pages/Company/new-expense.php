...
<div class="container py-5 h-100">
    ...
    <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form action="../../backend/data/record-expense-data.php" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="expenseAcc" class="form-label">Expense Account</label>
                        <select name="expenseAcc" id="expenseAcc" class="form-select" required>
                            <?php
                            $sql = "SELECT sub_account_id, sub_account_name FROM sub_account_tbl sat INNER JOIN account_tbl at ON (sat.account_id = at.account_id) WHERE at.account_name='Expenses'";
                ...
                <div class="col-md-6">
                    ...
                    <div class="container">
                        <div class="upload-receipts mt-3">
                            <h5>Drag or Drop your Receipt</h5>
                            <div class="drop-zone">
                                <input type="file" id="receipt-upload" name="bill" accept=".pdf">
...
<script>
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            // page title
            $(document).prop("title", "New Expense | Ginum");
        })
    })
</script>