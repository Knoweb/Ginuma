...
<div class="container py-4">
    <h2>Update Inventory for Items</h2>
    ...
    <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <h3 class="text-center">Current Inventory Status</h3>
        <hr>
        <h5>Current Inventory Balance: <span
                class="text-primary"><?= $_SESSION['currency_code'] . " " . $inventory_balance ?></span></h5>
        <h5>Required Inventory Balance: <span class="text-danger"><?= $_SESSION['currency_code'] . " " ?><span
                    class="balance"><?= $inventory_balance - $sum_of_unit_price ?></span></span></h5>
    </div>
    ...
    <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form action="../../backend/data/update-inventory-item-data.php" method="post">
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"
                                    id="basic-addon3"><?= $_SESSION['currency_code'] ?></span>
