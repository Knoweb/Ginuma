...
(368, '2024-09-25 06:53:26', 1, 1, NULL, '100300.00'),
(372, '2024-09-25 07:51:46', 1, 33, NULL, '0.00'),
...
INSERT INTO `company_tbl` (`company_id`, `company_name`, `company_category_id`, `company_reg_no`, `vat_no`, `tin_no`, `company_registered_address`, `company_factory_address`, `phone_no`, `mobile_no`, `email`, `website_url`, `date_joined`, `date_updated`, `password`, `img_path`, `br_report_path`, `country_id`, `currency_id`, `privilege_id`, `status`) VALUES
(1, 'Lycoris Cafe', 6, 'R001', 'VAT001', 'TIN001', 'Cinnamon Garden,\r\nGalle', 'He He,\r\nGalle', '0123456789', '', 'lycoris@host.com', '', '2024-05-04', '2024-08-09', '$2y$10$yOSRYn5dshHgWkwYt6OOf.BdE8fgUCePtOQTkTNV5POdIAqynku3O', '../../assets/imgs/uploads/business_img/Lycoris Cafe.png', NULL, 153, 142, 3, 1),
(9, 'Test', 1, '002', '002', '002', 'Galle', '', '', '0456789123', 'test@host.com', '', '2024-08-05', NULL, '$2y$10$.Q5xdv/BNIFgPnW4aiqUIumbqmM6X2B85hrgGE3pfDmMfa/vC/YpG', '', NULL, 153, 122, 3, 0),
(10, 'Test 10', 1, '', '', '', 'Galle', '', '0456789123', '', 'test10@host.com', '', '2024-09-26', NULL, '$2y$10$hm92PSYjyQS1kVcIAILWvuvKVoSmnUddrqwlVn5jcDHUvWpo.dylG', '', NULL, 153, 122, 3, 0);
...
(1, 'Dasun Nethsara', 'dasun@host.com', '0775555555', 'Galle', '200423203646', 'Individual', NULL, 'TIN002', NULL, '2024-05-04', '2024-09-04', 1, 1),
...
(3, 1, 'MGT', 'Management', 'Management Department');
...
(2, 'Dasun', 'Nethsara', 'Male', 2, 1, 'Colombo', '0775555555', '2004-08-19', '200423203646', 'EPF001', 'dasun@host.com', '2024-02-19', '2024-05-06', '2024-08-09', '../../assets/imgs/uploads/employee_img/200423203646.png', 1),
(4, 'Angela', 'Yue', 'Female', 5, 1, 'Japan', '0773333333', '1997-04-23', '199723203646', 'EPF003', 'anjela@host.com', '2019-06-15', '2024-05-06', '2024-08-09', '../../assets/imgs/uploads/employee_img/199723203646.png', 1),
(5, 'Sunil', 'Perera', 'Male', 10, 1, 'Matara', '0772222222', '1996-05-08', '199623203646', 'EPF004', 'sunil@host.com', '2022-12-05', '2024-06-26', NULL, '', 1);
...
(5, 6, 'Admin Dashboard', 'Medium', '2024-05-11', '2024-05-15', 'Admin Dashboard', 1),
(6, 6, 'Add User', 'Low', '2024-05-12', '2024-06-11', 'Add User', 1);
...
--
-- Dumping data for table `transaction_log_tbl`
--

INSERT INTO `transaction_log_tbl` (`transaction_id`, `company_id`, `transaction_date`, `debit_account`, `credit_account`, `transaction_type`, `amount`, `description`) VALUES
(228, 1, '2024-09-25 14:45:45', 1, 5, 'Assets Addition', '100000.00', 'Initial Balance');
...
--
ALTER TABLE `bank_account_tbl`
  MODIFY `bank_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `bank_details_tbl`
--
ALTER TABLE `bank_details_tbl`
  MODIFY `bank_details_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `bank_statement_tbl`
--
ALTER TABLE `bank_statement_tbl`
  MODIFY `stmt_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `company_sub_account_balance`
  MODIFY `company_sub_account_balance_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=376;
...
--
ALTER TABLE `designation_tbl`
  MODIFY `designation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `expense_tbl`
  MODIFY `expense_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `extended_tax_tbl`
--
ALTER TABLE `extended_tax_tbl`
  MODIFY `ext_tax_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `income_tbl`
--
ALTER TABLE `income_tbl`
  MODIFY `income_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `inventory_tbl`
--
ALTER TABLE `inventory_tbl`
  MODIFY `inventory_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `payroll_tbl`
  MODIFY `payroll_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `quotation_item_tbl`
  MODIFY `quotation_item_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `quotation_tbl`
--
ALTER TABLE `quotation_tbl`
  MODIFY `quotation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `sales_receipt_tbl`
--
ALTER TABLE `sales_receipt_tbl`
  MODIFY `receipt_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `sub_account_type_tbl`
  MODIFY `sub_account_type_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `sub_logins_tbl`
--
ALTER TABLE `sub_logins_tbl`
  MODIFY `sub_login_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `taxes_tbl`
  MODIFY `tax_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `transaction_log_tbl`
--
ALTER TABLE `transaction_log_tbl`
  MODIFY `transaction_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
ALTER TABLE `transaction_log_tbl`
  ADD COLUMN `sub_account_id` INT DEFAULT NULL,
  ADD KEY `sub_account_id` (`sub_account_id`),
  ADD CONSTRAINT `fk_transaction_sub_account`
      FOREIGN KEY (`sub_account_id`) REFERENCES `sub_account_tbl` (`sub_account_id`) ON DELETE CASCADE;
